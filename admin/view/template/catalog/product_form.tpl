...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
     ...
     <label class="col-sm-2 control-label" for="input-custom_plan">
         <span data-toggle="tooltip" title="<?php echo $help_custom_plan; ?>"><?php echo $entry_custom_plan; ?></span>
     </label>
     <div class="col-sm-10">
      <select name="custom_plan" id="custom_plan" class="form-control">
                    <option  <?php if ($custom_plan == "Basic") { ?>  selected="selected" <?php } ?> value="Basic">Basic</option>
                    <option  <?php if ($custom_plan == "Gold") { ?>  selected="selected" <?php } ?>  value="Gold">Gold</option>
                    <option  <?php if ($custom_plan == "Platinnum") { ?>  selected="selected" <?php } ?>  value="Platinnum">Platinnum</option>
                    
                  </select> 
        
     </div>
</div><!-- End of AjayKTiwari code  -->
<!-- AjayKTiwari code  -->
                  <div class="form-group">
     <label class="col-sm-2 control-label" for="input-custom_shortdesc">
         <span data-toggle="tooltip" title="<?php echo $help_custom_shortdesc; ?>"><?php echo $entry_custom_shortdesc; ?></span>
     </label>
     <div class="col-sm-10">
    <input type="text" name="custom_shortdesc" value="<?php echo $custom_shortdesc; ?>" maxlength="255" placeholder="<?php echo $entry_custom_shortdesc; ?> (Max Length 255)" id="input-custom_shortdesc" class="form-control" />
     ...
     <div class="col-sm-10">
     <textarea name="custom_desc" placeholder="<?php echo $entry_custom_desc; ?>" id="custom_desc" ><?php echo $custom_desc; ?></textarea>
        
     </div>
</div><!-- End of AjayKTiwari code  -->
<!-- AjayKTiwari code  -->
                  <div class="form-group">
     <label class="col-sm-2 control-label" for="input-custom_shortaddress">
         <span data-toggle="tooltip" title="<?php echo $help_custom_shortaddress; ?>"><?php echo $entry_custom_shortaddress; ?></span>
     </label>
     <div class="col-sm-10">
    <input type="text" name="custom_shortaddress" value="<?php echo $custom_shortaddress; ?>" maxlength="255" placeholder="<?php echo $entry_custom_shortaddress; ?> (Max Length 255)" id="input-custom_shortaddress" class="form-control" />
        
     </div>
</div><!-- End of AjayKTiwari code  -->
 <!-- AjayKTiwari code  -->
                  <div class="form-group">
     <label class="col-sm-2 control-label" for="input-custom_address">
         <span data-toggle="tooltip" title="<?php echo $help_custom_address; ?>"><?php echo $entry_custom_address; ?></span>
     </label>
     <div class="col-sm-10">
     <textarea name="custom_address" placeholder="<?php echo $entry_custom_address; ?>" id="custom_address" ><?php echo $custom_address; ?></textarea>
...
$('#custom_desc').summernote({height: 300});
$('#custom_address').summernote({height: 300});
<?php } ?>
