...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_custom_desc'] = $this->language->get('entry_custom_desc'); //AjayKTiwari custom code
		$data['entry_custom_shortdesc'] = $this->language->get('entry_custom_shortdesc');
		$data['entry_custom_address'] = $this->language->get('entry_custom_address');
		$data['entry_custom_shortaddress'] = $this->language->get('entry_custom_shortaddress');
		$data['entry_custom_plan'] = $this->language->get('entry_custom_plan');
		...
		$data['help_custom_address'] = $this->language->get('help_custom_address'); // AjayKTiwari
		$data['help_custom_shortaddress'] = $this->language->get('help_custom_shortaddress');
		$data['help_custom_shortdesc'] = $this->language->get('help_custom_shortdesc'); 
		$data['help_custom_plan'] = $this->language->get('help_custom_plan');
		...
		//AjayKTiwari code
		if (isset($this->request->post['custom_shortdesc'])) {
 		$data['custom_shortdesc'] = $this->request->post['custom_shortdesc'];
		} elseif (!empty($product_info)) {
 			$data['custom_shortdesc'] = $product_info['custom_shortdesc'];
			} else {
 			$data['custom_shortdesc'] = '';
			}
				
	  if (isset($this->request->post['custom_address'])) {
 		$data['custom_address'] = $this->request->post['custom_address'];
		} elseif (!empty($product_info)) {
 			$data['custom_address'] = $product_info['custom_address'];
			} else {
 			$data['custom_address'] = '';
			}
		
	 if (isset($this->request->post['custom_shortaddress'])) {
 		$data['custom_shortaddress'] = $this->request->post['custom_shortaddress'];
		} elseif (!empty($product_info)) {
 			$data['custom_shortaddress'] = $product_info['custom_shortaddress'];
			} else {
 			$data['custom_shortaddress'] = '';
			}
					
     if (isset($this->request->post['custom_plan'])) {
 		$data['custom_plan'] = $this->request->post['custom_plan'];
		} elseif (!empty($product_info)) {
 			$data['custom_plan'] = $product_info['custom_plan'];
			} else {
 			$data['custom_plan'] = '';
			}
