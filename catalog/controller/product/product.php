...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['custom_shortdesc'] = html_entity_decode($product_info['custom_shortdesc'], ENT_QUOTES, 'UTF-8');
			$data['custom_address'] = html_entity_decode($product_info['custom_address'], ENT_QUOTES, 'UTF-8');
			$data['custom_shortaddress'] = html_entity_decode($product_info['custom_shortaddress'], ENT_QUOTES, 'UTF-8');
			$data['custom_plan'] = $product_info['custom_plan']; //AjayKTiwari custom code
