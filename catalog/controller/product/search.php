		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'custom_shortdesc' => html_entity_decode($result['custom_shortdesc'], ENT_QUOTES, 'UTF-8'),
					'custom_shortaddress' => html_entity_decode($result['custom_shortaddress'], ENT_QUOTES, 'UTF-8'),
					'price'       => $price,
					'special'     => $special,
					'tax'         => $tax,
