	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'custom_desc'      => $query->row['custom_desc'], // AjayKTiwari custom code
				'custom_shortdesc' => $query->row['custom_shortdesc'], // AjayKTiwari custom code
				'custom_address'      => $query->row['custom_address'],
				'custom_shortaddress'      => $query->row['custom_shortaddress'],
				'custom_plan'      => $query->row['custom_plan'],
